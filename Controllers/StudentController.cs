...
namespace ASPNETCore_DB.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        {
            var studentExit = _studentRepo.ByEmail(this.User.Identity.Name.ToString());
            if(studentExit != null)
            {
                return RedirectToAction("Details", "Student", studentExit.StudentNumber);
            }
            else 
            {
